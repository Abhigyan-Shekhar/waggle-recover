...
async def run_demo_scenario(
    ...
    from app.evaluation.robustness import _with_robustness_cases
    scenarios.append(_with_robustness_cases(42, 9)[7])
    ...
    scenario = isolate_demo_run(scenario, uuid.uuid4().hex[:6])
