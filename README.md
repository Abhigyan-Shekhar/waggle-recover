...
The preregistered run gave **directional support for H1** under its locked rule. Across seeds, static vs adaptive mean success was **47.56% vs 48.22%** (+0.66 percentage points), recovered GMV was **₹230,700 vs ₹233,800** (+₹3,100, about 1.3%), optimal viable-action selection was **73.33% vs 75.11%** (+1.78 points), and cumulative viable-action regret was **₹49,971 vs ₹48,072** (-₹1,899, about 3.8%). The regret reduction and optimal-action increase are the clearest adaptation signals. Two seeds improved, three were unchanged, and none became worse. The improvement appeared only in the warm phase; when merchant evidence remained weak or posterior separation stayed below the preregistered five-point threshold, Waggle deliberately preserved the static safe strategy instead of overfitting sparse observations. These synthetic results demonstrate bounded online adaptation, not production uplift or statistical significance.
